...
# --- Insert your code here ---
 def find_max_sentiment(Comprehend_Sentiment_Output):
    ...
    return Comprehend_Sentiment_Output['Sentiment'], 
# -----------------------------
...
def lambda_handler(event, context):
    ...
    sentiment = client.detect_sentiment(
        Text = enquiry_text,
        LanguageCode = 'en') # <---Insert code to get the sentiment with AWS comprehend
    # -----------------------------
    
    # --- Insert your code here ---
    key_phrases = client.detect_key_phrases(
        Text = enquiry_text,
        LanguageCode = 'en') # <--- Insert code to get the key phrases with AWS comprehend
    # -----------------------------
    ...
    # --- Insert your code here ---
    # Do not change the name of this variable
    email_text = 'This is a test email for testing purpose!!'
    ...
    # --- Insert your code here ---
    SENDER = 'ezethugaxo@gmail.com.com'
    # -----------------------------

    # Replace recipient@example.com with a "To" address. If your account 
    # is still in the sandbox, this address must be verified.
    # --- Insert your code here ---
    RECIPIENT = 'ezethugaxo@gmail.com' 
    # -----------------------------
